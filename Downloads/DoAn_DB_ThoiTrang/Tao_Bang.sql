...
CREATE TABLE PHIEUNHAP (
    ...
    TongTien NUMBER(18, 2) DEFAULT 0 NOT NULL CHECK (TongTien >= 0),
...
CREATE TABLE LICHSUDOITRA (
    ...
    MaDH VARCHAR2(20) NOT NULL,
    MaSP VARCHAR2(20) NOT NULL,
    NgayDoiTra DATE DEFAULT SYSDATE,
    SoLuong NUMBER NOT NULL CHECK (SoLuong > 0),
    LyDo NVARCHAR2(500),
    ThanhTien NUMBER(18, 2) DEFAULT 0 CHECK (ThanhTien >= 0),
    -- Khóa ngoại liên kết
    CONSTRAINT fk_dt_dh FOREIGN KEY (MaDH) REFERENCES DONHANG(MaDH),
    CONSTRAINT fk_dt_sp FOREIGN KEY (MaSP) REFERENCES SANPHAM(MaSP)
);

CREATE TABLE CHITIET_DANHMUC (
    MaSP VARCHAR2(20) NOT NULL,
    MaDM VARCHAR2(20) NOT NULL,
    PRIMARY KEY (MaSP, MaDM), -- Khóa chính kép chặn việc ghép trùng
    CONSTRAINT fk_ctdm_sp FOREIGN KEY (MaSP) REFERENCES SANPHAM(MaSP) ON DELETE CASCADE,
    CONSTRAINT fk_ctdm_dm FOREIGN KEY (MaDM) REFERENCES DANHMUC(MaDM) ON DELETE CASCADE
);
